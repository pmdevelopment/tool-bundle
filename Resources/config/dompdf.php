 ...
 */
define("DOMPDF_DIR", $kernel_dir . "/../vendor/dompdf/dompdf");
define("PHP_FONT_LIB_DIR", $kernel_dir . "/../vendor/phenx/php-font-lib");
/**
...
if (DOMPDF_ENABLE_AUTOLOAD) {
  ...
  require_once(PHP_FONT_LIB_DIR . "/classes/font.cls.php");
}
